    ...
    C: Has<XSpanIdString>  + Clone + Send + Sync + 'static,
{
        ...
        context: &C) -> Result<AddressbookAddressKeyAddrtypeDeleteResponse, ApiError>
    {
        ...
        let mut uri = format!(
            ...
            self.base_path
            ,address_key=utf8_percent_encode(&param_address_key.to_string(), ID_ENCODE_SET)
        );
        ...
        match response.status().as_u16() {
            200 => {
                ...
                Ok(AddressbookAddressKeyAddrtypeDeleteResponse::OK
                    (body)
                )
            }
            code => {
        ...
        context: &C) -> Result<AddressbookAddressKeyAddrtypeGetResponse, ApiError>
    {
        ...
        match response.status().as_u16() {
            200 => {
                ...
                Ok(AddressbookAddressKeyAddrtypeGetResponse::OK
                    (body)
                )
            }
            code => {
        ...
        context: &C) -> Result<AddressbookAddressKeyAddrtypePutResponse, ApiError>
    {
        ...
        match response.status().as_u16() {
            200 => {
                ...
                Ok(AddressbookAddressKeyAddrtypePutResponse::OK
                    (body)
                )
            }
            code => {
        ...
        context: &C) -> Result<AddressbookAddressKeyCityDeleteResponse, ApiError>
    {
        ...
        match response.status().as_u16() {
            200 => {
                ...
                Ok(AddressbookAddressKeyCityDeleteResponse::OK
                    (body)
                )
            }
            code => {
        ...
        context: &C) -> Result<AddressbookAddressKeyCityGetResponse, ApiError>
    {
        ...
        match response.status().as_u16() {
            200 => {
                ...
                Ok(AddressbookAddressKeyCityGetResponse::OK
                    (body)
                )
            }
            code => {
        ...
        context: &C) -> Result<AddressbookAddressKeyCityPutResponse, ApiError>
    {
        ...
        match response.status().as_u16() {
            200 => {
                ...
                Ok(AddressbookAddressKeyCityPutResponse::OK
                    (body)
                )
            }
            code => {
        ...
        context: &C) -> Result<AddressbookAddressKeyCountryDeleteResponse, ApiError>
    {
        ...
        match response.status().as_u16() {
            200 => {
                ...
                Ok(AddressbookAddressKeyCountryDeleteResponse::OK
                    (body)
                )
            }
            code => {
        ...
        context: &C) -> Result<AddressbookAddressKeyCountryGetResponse, ApiError>
    {
        ...
        match response.status().as_u16() {
            200 => {
                ...
                Ok(AddressbookAddressKeyCountryGetResponse::OK
                    (body)
                )
            }
            code => {
        ...
        context: &C) -> Result<AddressbookAddressKeyCountryPutResponse, ApiError>
    {
        ...
        match response.status().as_u16() {
            200 => {
                ...
                Ok(AddressbookAddressKeyCountryPutResponse::OK
                    (body)
                )
            }
            code => {
        ...
        context: &C) -> Result<AddressbookAddressKeyDeleteResponse, ApiError>
    {
        ...
        match response.status().as_u16() {
            200 => {
                ...
                let body = str::from_utf8(&body)
                    .map_err(|e| ApiError(format!("Response was not valid UTF8: {}", e)))?;
                let body = serde_json::from_str::<models::Addressbook>(body).map_err(|e| {
                    ApiError(format!("Response body did not match the schema: {}", e))
                })?;
                Ok(AddressbookAddressKeyDeleteResponse::OK
                    (body)
                )
            }
            code => {
        ...
        context: &C) -> Result<AddressbookAddressKeyGetResponse, ApiError>
    {
        ...
        match response.status().as_u16() {
            200 => {
                ...
                Ok(AddressbookAddressKeyGetResponse::OK
                    (body)
                )
            }
            code => {
        ...
        context: &C) -> Result<AddressbookAddressKeyPatchResponse, ApiError>
    {
        ...
        match response.status().as_u16() {
            200 => {
                ...
                Ok(AddressbookAddressKeyPatchResponse::OK
                    (body)
                )
            }
            code => {
        ...
        context: &C) -> Result<AddressbookAddressKeyPersonUuidDeleteResponse, ApiError>
    {
        ...
        match response.status().as_u16() {
            200 => {
                ...
                Ok(AddressbookAddressKeyPersonUuidDeleteResponse::OK
                    (body)
                )
            }
            code => {
        ...
        context: &C) -> Result<AddressbookAddressKeyPersonUuidGetResponse, ApiError>
    {
        ...
        match response.status().as_u16() {
            200 => {
                ...
                Ok(AddressbookAddressKeyPersonUuidGetResponse::OK
                    (body)
                )
            }
            code => {
        ...
        context: &C) -> Result<AddressbookAddressKeyPersonUuidPutResponse, ApiError>
    {
        ...
        match response.status().as_u16() {
            200 => {
                ...
                Ok(AddressbookAddressKeyPersonUuidPutResponse::OK
                    (body)
                )
            }
            code => {
        ...
        context: &C) -> Result<AddressbookAddressKeyPutResponse, ApiError>
    {
        ...
        match response.status().as_u16() {
            200 => {
                ...
                Ok(AddressbookAddressKeyPutResponse::OK
                    (body)
                )
            }
            code => {
        ...
        context: &C) -> Result<AddressbookAddressKeyStateDeleteResponse, ApiError>
    {
        ...
        match response.status().as_u16() {
            200 => {
                ...
                Ok(AddressbookAddressKeyStateDeleteResponse::OK
                    (body)
                )
            }
            code => {
        ...
        context: &C) -> Result<AddressbookAddressKeyStateGetResponse, ApiError>
    {
        ...
        match response.status().as_u16() {
            200 => {
                ...
                Ok(AddressbookAddressKeyStateGetResponse::OK
                    (body)
                )
            }
            code => {
        ...
        context: &C) -> Result<AddressbookAddressKeyStatePutResponse, ApiError>
    {
        ...
        match response.status().as_u16() {
            200 => {
                ...
                Ok(AddressbookAddressKeyStatePutResponse::OK
                    (body)
                )
            }
            code => {
        ...
        context: &C) -> Result<AddressbookAddressKeyStreetDeleteResponse, ApiError>
    {
        ...
        match response.status().as_u16() {
            200 => {
                ...
                Ok(AddressbookAddressKeyStreetDeleteResponse::OK
                    (body)
                )
            }
            code => {
        ...
        context: &C) -> Result<AddressbookAddressKeyStreetGetResponse, ApiError>
    {
        ...
        match response.status().as_u16() {
            200 => {
                ...
                Ok(AddressbookAddressKeyStreetGetResponse::OK
                    (body)
                )
            }
            code => {
        ...
        context: &C) -> Result<AddressbookAddressKeyStreetPutResponse, ApiError>
    {
        ...
        match response.status().as_u16() {
            200 => {
                ...
                Ok(AddressbookAddressKeyStreetPutResponse::OK
                    (body)
                )
            }
            code => {
        ...
        context: &C) -> Result<AddressbookDeleteResponse, ApiError>
    {
        ...
        match response.status().as_u16() {
            200 => {
                ...
                Ok(AddressbookDeleteResponse::OK
                    (body)
                )
            }
            code => {
        ...
        context: &C) -> Result<AddressbookGetResponse, ApiError>
    {
        ...
        match response.status().as_u16() {
            200 => {
                ...
                let body = str::from_utf8(&body)
                    .map_err(|e| ApiError(format!("Response was not valid UTF8: {}", e)))?;
                let body = serde_json::from_str::<Vec<models::Addressbook>>(body).map_err(|e| {
                    ApiError(format!("Response body did not match the schema: {}", e))
                })?;
                Ok(AddressbookGetResponse::OK
                    (body)
                )
            }
            code => {
        ...
        context: &C) -> Result<AddressbookPatchResponse, ApiError>
    {
        ...
        match response.status().as_u16() {
            200 => {
                ...
                Ok(AddressbookPatchResponse::OK
                    (body)
                )
            }
            code => {
    ...
    async fn addressbook_post(
        &self,
        param_addressbook_post_request: models::AddressbookPostRequest,
        param_limit: Option<i32>,
        param_offset: Option<i32>,
        context: &C) -> Result<AddressbookPostResponse, ApiError>
    {
        ...
        let body = serde_json::to_string(&param_addressbook_post_request).expect("impossible to fail to serialize");
        ...
        match response.status().as_u16() {
            201 => {
                ...
                Ok(AddressbookPostResponse::CREATED
                    (body)
                )
            }
            code => {
